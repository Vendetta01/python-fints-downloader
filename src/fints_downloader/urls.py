...
urlpatterns = [
    ...
    path('transaction/<str:pk>/', transaction.TransactionDetail.as_view(),
         name='transaction'),
    path('categories/', category.CategoryList.as_view(),
         name='categories'),
    path('category/<str:pk>/', category.CategoryDetail.as_view(),
         name='category'),

    path('', index.IndexView.as_view(), name='index'),
    path('accounts/', account.AccountListView.as_view(),
         name='accounts'),
    ...
    path('import/accounts/', importer.ImportAccountsView.as_view(),
